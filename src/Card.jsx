...
function Card(props) {
    ...
    return(
        <div className="grid 2xl:grid-cols-3 justify-items-center">
            {results.map((result) => {
                return(
                    <div key={result.id} className="2xl:w-96 w-80 rounded-3xl relative mt-12 flex justify-center flex-wrap shadow-xl">
                        <img src={result.image} className="rounded-t-3xl 2xl:w-96 w-80 h-52 2xl:h-60" alt="image"/>
